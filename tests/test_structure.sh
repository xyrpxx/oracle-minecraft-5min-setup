...
for f in README.md README.fr.md LICENSE .gitignore .gitattributes setup.sh manage.sh uninstall.sh start-windows.bat \
         ...
         utils/rcon_client.py utils/backup.sh utils/restore.sh utils/monitor.sh utils/update.sh utils/console.sh utils/auto-sleep.sh \
         security/hardening.sh security/whitelist_manager.sh security/keepalive.sh security/discord-alert@.service \
